...
{
	_RPT1(_CRT_WARN, "Warning : %s\n", m_info);
	MessageBox(NULL, m_info, "VNC info", MB_OK| MB_ICONEXCLAMATION | MB_SETFOREGROUND | MB_TOPMOST);
}
...
{
	_RPT1(_CRT_WARN, "Warning : %s\n", m_info);
	MessageBox(NULL, m_info, "VNC info", MB_OK | MB_ICONSTOP | MB_SETFOREGROUND | MB_TOPMOST);
}